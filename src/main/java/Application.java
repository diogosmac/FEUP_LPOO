...
public class Application {
    public static void main(String[] args) {
        ...
        AreaStringOutputter aggregatorStringOutputter = new AreaStringOutputter(aggregator);
        AreaXMLOutputter xmlOutputter = new AreaXMLOutputter(aggregator);

        System.out.println(aggregatorStringOutputter.output());
        ...
        System.out.println(cityXmlOutputter.outputXML());
    }
}
